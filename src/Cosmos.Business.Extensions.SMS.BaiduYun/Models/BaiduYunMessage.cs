...
namespace Cosmos.Business.Extensions.SMS.BaiduYun.Models
{
    public class BaiduYunMessage
    {
        ...
        public virtual void CheckParameters()
        {
            ...
            {
                throw new InvalidArgumentException("收信人为空", BaiduYunSmsConstants.ServiceName, 401);
            }

            if (string.IsNullOrWhiteSpace(TemplateCode))
            {
                throw new InvalidArgumentException("短信模板 ID 不能为空", BaiduYunSmsConstants.ServiceName, 401);
            }
        }
